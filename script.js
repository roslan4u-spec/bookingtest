// JavaScript for TERB Activities & Direction Interactivity + Bilingual (BM/EN) Support

const translations = {
    bm: {
        announcement_welcome: 'Selamat Datang ke TERB – Hutan Lipur Berkelah, Pahang',
        ...
        hero_badge: 'Hutan Lipur Berkelah, Pahang',
        hero_title: 'AKTIVITI & PANDUAN JALAN TERB',
        hero_desc: 'Terokai keindahan semula jadi Air Terjun 7 Tingkat di Hutan Lipur Berkelah, Pahang. Nikmati perkelahan, mandi sungai, BBQ, dan pelbagai aktiviti riadah air yang menyeronokkan!',
        hero_btn_direction: 'Panduan Jalan ke Hutan Lipur Berkelah',
        hero_btn_activities: 'Terokai Aktiviti',
        dir_badge: 'Panduan Lokasi & Perjalanan',
        dir_title: 'Panduan Jalan ke Hutan Lipur Berkelah, Pahang',
        dir_desc: 'Hutan Lipur Berkelah terletak di daerah Maran/Gambang, Pahang. Terkenal dengan keindahan air terjun 7 tingkat dan air sungai yang sejuk serta jernih.',
        dir_routes_header: 'Panduan Laluan Utama',
        dir_route1_title: 'Dari Kuala Lumpur / Pantai Barat (LPT1)',
        dir_route1_steps: '<li>Guna <strong>Lebuhraya Pantai Timur (LPT1)</strong> menghala ke Kuantan.</li><li>Ambil <strong>Susur Keluar Sri Jaya / Gambang</strong> (Keluar 825 atau Keluar 827).</li><li>Masuk ke <strong>Jalan Maran-Kuantan (Laluan 2)</strong> dan ikuti papan tanda menghala ke Hutan Lipur Berkelah.</li><li>Belok ke simpang jalan berturap Hutan Lipur Berkelah sehingga tiba di kawasan letak kenderaan & pintu masuk.</li>',
        dir_route2_title: 'Dari Bandar Kuantan / Gambang',
        dir_route2_steps: '<li>Guna <strong>Jalan Kuantan - Maran (Laluan 2)</strong> menghala ke arah Gambang / Sri Jaya.</li><li>Pandu melepasi Pusat Asasi UIA Gambang / Simpang Gambang.</li><li>Belok kanan di papan tanda rasmi <strong>Hutan Lipur Berkelah</strong> dan teruskan perjalanan hingga ke pintu masuk.</li>',
        dir_parking_title: 'Kemudahan Tempat Letak Kenderaan',
        dir_parking_desc: 'Disediakan di pintu masuk utama Hutan Lipur Berkelah.',
        ...
        act_subheading: 'Pilih aktiviti di bawah untuk melihat maklumat lanjut dan panduan keselamatan di TERB Hutan Lipur Berkelah.',
        tab_bbq: 'Barbeque',
        tab_picnic: 'Berkelah',
        ...
        bbq_title: 'Barbeque',
        bbq_desc: 'Nikmati hidangan panggang panas di tepi sungai Hutan Lipur Berkelah yang jernih dan nyaman. Tapak BBQ disediakan untuk kemudahan anda dan keluarga.',
        ...
        picnic_desc: 'Sesuai untuk berkelah harian bersama keluarga di bawah pepohonan rimba Hutan Lipur Berkelah yang redup dan menyegarkan.',
        ...
        swim_desc: 'Berenang dan mandi-manda di air terjun 7 tingkat yang begitu jernih, sejuk dan menyegarkan di Hutan Lipur Berkelah, Pahang.',
        ...
        rules_desc: 'Demi menjaga ketenteraman, kebersihan, dan keselamatan semua pengunjung di TERB Hutan Lipur Berkelah, aktiviti dan barangan berikut adalah <strong>DILARANG SAMA SEKALI</strong>:',
        ...
        penalty_desc: 'Sebarang aktiviti yang dijalankan tanpa kebenaran pihak pengurusan TERB adalah <strong>DILARANG SAMA SEKALI</strong>. Denda <strong>RM500</strong> akan dikenakan bagi sebarang pelanggaran peraturan.',
        btn_more_info: 'Hubungi Untuk Pertanyaan Lanjut',
        contact_title: 'Pertanyaan & Tempahan',
        contact_desc: 'Sila WhatsApp atau hubungi kami secara terus untuk sebarang pertanyaan berkaitan aktiviti dan tempahan di TERB.',
        contact_button: 'Hubungi / WhatsApp: 019-4489296',
        footer_about: 'Destinasi riadah & perkelahan air terjun terkemuka di Hutan Lipur Berkelah, Mukim Luit, Pahang.',
        footer_nav_header: 'Pautan Pantas',
        footer_contact_header: 'Hubungi Kami',
        footer_address: 'Hutan Lipur Berkelah, Mukim Luit, Pahang, Malaysia',
        back_to_top: 'Kembali ke atas'
    },
    en: {
        announcement_welcome: 'Welcome to TERB – Berkelah Forest Reserve, Pahang',
        top_contact: '019-4489296',
        ...
        hero_title: 'TERB ACTIVITIES & DIRECTION',
        ...
        act_subheading: 'Select an activity below to view details and safety guidelines at TERB Berkelah Forest Reserve.',
        tab_bbq: 'Barbeque',
        tab_picnic: 'Picnic',
        ...
        rules_desc: 'To maintain peace, cleanliness, and safety for all visitors at TERB Berkelah Forest Reserve, the following activities and items are <strong>STRICTLY PROHIBITED</strong>:',
        ...
        penalty_desc: 'Unapproved activities without TERB management permission are <strong>STRICTLY PROHIBITED</strong>. A fine of <strong>RM500</strong> will be imposed for any rule violation.',
        btn_more_info: 'Further Inquiries',
        contact_title: 'Inquiries & Reservations',
        contact_desc: 'Please WhatsApp or call us directly for activity inquiries & bookings at TERB.',
